...
def user(username):
    ...
    #karna logika pengecualian nya sama yaitu ke 'home' maka bisa kita satukan saja. Berbeda dengan yang ada pada home(), disana terdapat msg yang berbeda jadi kita bedakan.   
    except (
...
def update_like():
    ...
    try:
        ...
        user_info = db.users.find_one({'username' : 
        payload.get('id')})
